...
app.get('/api/update/check', (req, res) => {
    try {
        ...
        const latestVersion = versionData.version || CURRENT_VERSION;
        ...
        res.json({
            ...
            minServerVersion: versionData.minServerVersion || '1.20.4',
...
app.get('/api/update/info', (req, res) => {
    let versionData = { name: 'PurpleMC Panel' };
    try {
        if (fs.existsSync(VERSION_FILE)) {
    ...
    res.json({
        ...
        name: versionData.name || 'PurpleMC Panel',
